...
public class StockSendRule {
  ...
  /** 양도 허용 여부, 아직 미개방 설명: 입력하지 않으면 기본값은 아니오, 열거형 값: true: 예 false: 아니오 참고: 해당 필드는 아직 미개방 */
  @SerializedName("transferable")
  private Boolean transferable;

  /** 링크 공유 허용 여부, 아직 미개방 설명: 입력하지 않으면 기본값은 아니오, 열거형 값: true: 예 false: 아니오 참고: 해당 필드는 아직 미개방 */
