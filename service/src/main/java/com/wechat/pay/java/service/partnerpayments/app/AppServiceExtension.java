 ...
 * APP 결제의 확장 클래스.
 *
 * <p>AppService를 캡슐화하고 향상된 APP 주문 메서드 prepayWithRequestPayment를 제공합니다.
 */
public class AppServiceExtension {
  ...
  /**
   * APP 결제 주문하고 APP 결제 호출 데이터를 반환합니다. 권장 사용!
   *
   * <p>요청 성공 후, 이 메서드는 사전 결제 거래 세션 식별자 prepay_id와 클라이언트 APP 결제 호출에 필요한 매개변수를 반환합니다. AppService.prepay보다 더 간단하고 사용하기 쉬우며, 개발자가 결제 호출 서명을 직접 계산할 필요가 없기 때문입니다.
   *
