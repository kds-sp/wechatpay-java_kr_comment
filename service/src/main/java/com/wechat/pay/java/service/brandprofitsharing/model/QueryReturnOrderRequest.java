...
public class QueryReturnOrderRequest {
  ...
  /** 위챗 분할 내역 번호 설명: 원래 분할 요청을 시작할 때 위챗이 반환한 위챗 분할 내역 번호, 가맹점 분할 내역 번호와 일대일 대응. 위챗 분할 내역 번호와 가맹점 분할 내역 번호 중 하나만 입력 */
  @SerializedName("order_id")
  @Expose(serialize = false)
  private String orderId;

  /** 가맹점 분할 내역 번호 설명: 원래 분할 요청을 시작할 때 사용한 가맹점 시스템 내부의 분할 내역 번호. 위챗 분할 내역 번호와 가맹점 분할 내역 번호 중 하나만 입력 */
